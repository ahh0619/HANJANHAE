    ...
    <form onSubmit={handleReviewSubmit} className="mt-6">
      ...
      <div className="relative mt-2">
        <textarea
          name="comment"
          id="comment"
          className="h-[100px] w-full resize-none rounded-2xl border border-grayscale-600 bg-grayscale-100 p-4 text-body-mm text-grayscale-600 focus:outline-none focus:ring-2 focus:ring-gray-400"
