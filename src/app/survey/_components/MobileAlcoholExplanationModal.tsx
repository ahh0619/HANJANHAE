...
const MobileAlcoholExplanationModal = ({
  ...
  return (
    ...
    >
      <div
        className={`relative w-full max-w-lg rounded-t-[24px] bg-white transition-transform duration-300 ${
          isOpen ? 'translate-y-0' : 'translate-y-full'
        } h-[90%] max-h-[90%]`}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="sticky top-0 z-10 rounded-t-[24px] bg-white">
          <div className="relative px-[20px] pb-[36px] pt-[24px]">
            <OptimizedImage
              ...
              onClick={onClose}
            />
            <h2 className="text-center text-title-xl text-grayscale-900">
              주류 용어 설명
            </h2>
          </div>
        </div>
        ...
        {/* 스크롤 가능한 영역 */}
        <div className="custom-scrollbar h-full overflow-y-auto px-[20px]">
          <div className="mb-[60px] space-y-[24px] text-sm leading-6 text-grayscale-900">
            <div>
