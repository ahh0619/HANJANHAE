  ...
  return (
    <div className="px-[19px]">
      ...
      <div className="mb-10 h-[130px] w-[311px]">
        <div className="mb-[16px] h-[20px] w-[250px] animate-pulse rounded bg-gray-200" />
      ...
      {/* 2. 도수 선택 영역 스켈레톤 */}
      <div className="mb-10">
        <div className="mb-[16px] h-[20px] w-[150px] animate-pulse rounded bg-gray-200" />
      ...
      {Array.from({ length: 4 }).map((_, index) => (
        <div className="mb-10" key={index}>
          <div className="mb-[16px] h-[20px] w-[180px] animate-pulse rounded bg-gray-200" />
      ...
      {/* 5. 저장하기 버튼 스켈레톤 */}
      <div className="mb-[20px] mt-[80px] h-[54px] w-full animate-pulse rounded-[8px] bg-gray-200" />
    </div>
  );
};
